...
const translations = {
    en: {
        SignInForm: {
            ...
            toContinueDescription: 'To continue, Sublayer will share your name, email address, and profile picture with ${companyName}. Before using this app, you can review ${companyName}\'s [privacy policy](${privacyPolicyUrl}) and [terms of service](${termsOfServiceUrl}).',
    ...
    nl: {
        SignInForm: {
            ...
            toContinueDescription: 'Zodra je inlogt, zal Sublayer je naam, e-mailadres en profiel foto delen met ${companyName}. Voordat je deze app gaat gebruiken, kun je ${companyName}\'s [privacy policy](${privacyPolicyUrl}) en [terms of service](${termsOfServiceUrl}) bekijken.',
            privacyPolicy: 'privacy policy',
            termsOfService: 'terms of service',
        },
        VerifyingSession: {
